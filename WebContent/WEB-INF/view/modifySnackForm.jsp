...
<u:navbar></u:navbar>
	...
	<div class="row">
		...
		<div class="col-6">
			<h1>게시글 수정</h1>
			<form action="${root }/smodify.do" method="post">
			<!-- div.form-group>label[for=input1-title]+input.form-control#input1-title[name=title] -->
				<div class="form-group">
				<input type="text" name="no" value="${modReq.snackNo}" hidden/>
...
<%-- <body>
	<div class="container">
	<form action="smodify.do" method="post">
		<p>
			번호: <br /><input type="text" name="no" value="${modReq.snackNo}" readonly/>
		</p>
		<p>
